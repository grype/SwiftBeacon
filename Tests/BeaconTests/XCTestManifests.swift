...
extension FileLoggerTests {
    ...
    static let __allTests__FileLoggerTests = [
        ("testLogRotation", testLogRotation),
        ("testLogRotationOnStart", testLogRotationOnStart),
    ]
}

extension FileWheelTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__FileWheelTests = [
        ("testInit", testInit),
        ("testRotateInvokesBlock", testRotateInvokesBlock),
        ("testShouldRotateForZeroSize", testShouldRotateForZeroSize),
        ("testShouldRotateWhenFileDoesNotExist", testShouldRotateWhenFileDoesNotExist),
        ("testShouldRotateWhenFileExceedsMaxSize", testShouldRotateWhenFileExceedsMaxSize),
        ("testShouldRotateWhenFileIsEmpty", testShouldRotateWhenFileIsEmpty),
        ("testShouldRotateWhenFileWillExceedMaxSize", testShouldRotateWhenFileWillExceedMaxSize),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(FileWheelTests.__allTests__FileWheelTests),
