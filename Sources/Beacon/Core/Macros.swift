...
@freestanding(expression)
public macro emit<P: Publisher, S:Subject>(publisher: P, userInfo: Any? = nil, on: S = Beacon) = #externalMacro(module: "BeaconMacros", type: "EmitMacro") where S.Output == P.Output, S.Failure == P.Failure
