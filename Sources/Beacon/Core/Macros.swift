...
@freestanding(expression)
public macro emit<V: Publisher, S:Subject>(valuesPublishedBy: V, userInfo: Any? = nil, on: S = Beacon) -> AnyCancellable = #externalMacro(module: "BeaconMacros", type: "EmitMacro")
